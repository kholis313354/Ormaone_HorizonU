...
<div class="container">
    <div class="login-card">
        <div class="login-header">
            <div class="logo">
                <a href="<?= url_to('voting') ?>" class="logo-text text-decoration-none" style="color: #980517;"><img src="<?= base_url('dist/ormaone/img/logo1.png'); ?>" alt="">
                    <div class="logo-text text-decoration-none" style="color: #980517;">OrmaOne</div>
                </a>
            </div>
            <h4>MASUK</h4>
        </div>
