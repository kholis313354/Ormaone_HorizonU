    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?= url_to('user.store') ?>" method="POST" autocomplete="off">
                    <?= csrf_field() ?>
                    <div class="mb-3">
                        <label for="name" class="form-label">Nama</label>
                        <input type="text" class="form-control" id="name" name="name" placeholder="Nama"
                            value="<?= old('name') ?>" required minlength="3" maxlength="100" pattern="[a-zA-Z\s]+"
                    ...
                    <div class="mb-3">
                        ...
                        <select name="level" id="level" class="form-select" required>
                            ...
                            <option value="0" <?= old('level') == '0' ? 'selected' : '' ?>>Organisasi - Fakultas</option>
                            <option value="1" <?= old('level') == '1' ? 'selected' : '' ?>>CSDL</option>
                            <option value="2" <?= old('level') == '2' ? 'selected' : '' ?>>BEM Universitas</option>
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Pilih organisasi untuk user ini</small>
                    </div>
                    <div class="mb-3">
                        <label for="password" class="form-label">Password</label>
                        <input type="password" class="form-control" id="password" name="password"
                            placeholder="Minimal 8 karakter" required minlength="8" autocomplete="new-password">
                        <small class="text-muted">Password harus mengandung minimal 8 karakter</small>
                    </div>
                    <div class="mb-3">
