    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?= url_to('user.store') ?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="level" id="level" class="form-select">
                            <option value="0">Organisasi - Fakultas</option>
                            <option value="1">CSDL</option>
                            <option value="2">BEM Universitas</option>
                        </select>
                    </div>
                    <div class="mb-3">
