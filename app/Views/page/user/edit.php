                ...
                <form action="<?= url_to('user.update', $data['id']) ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="level" id="level" class="form-select">
                            <option value="0" <?= $data['level'] == '0' ? 'selected' : '' ?>>Organisasi - Fakultas</option>
                            <option value="1" <?= $data['level'] == '1' ? 'selected' : '' ?>>CSDL</option>
                            <option value="2" <?= $data['level'] == '2' ? 'selected' : '' ?>>BEM Universitas</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        ...
                        <select name="organisasi_id" id="organisasi_id" class="form-select">
                            ...
                            <?php if (isset($organisasis) && !empty($organisasis)): ?>
                                <?php foreach ($organisasis as $org): ?>
                                    <option value="<?= $org['id'] ?>" <?= (isset($data['organisasi_id']) && $data['organisasi_id'] == $org['id']) ? 'selected' : '' ?>>
                                        <?= esc($org['name']) ?>
                                    </option>
                                <?php endforeach; ?>
                            <?php endif; ?>
