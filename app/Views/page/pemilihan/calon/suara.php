    ...
    <div class="d-flex align-items-center justify-content-between gap-3">
        ...
        <div class="header-right">
            <div class="dropdown icon-btn-wrapper">
                <a class="icon-btn" id="navbarDropdownChat" href="#" role="button" data-bs-toggle="dropdown"
                ...
                <ul class="dropdown-menu dropdown-menu-end bg-brown" aria-labelledby="navbarDropdownChat">
                    <li>
                        <a class="dropdown-item text-light" href="#!">Pesan 1</a>
                        <hr class="dropdown-divider light" />
                    </li>
                    <li>
                        <a class="dropdown-item text-light" href="#!">Pesan 2</a>
                    </li>
                </ul>
            </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">
                    <?= $title ?> Calon <?= $pemilihan['number'] ?> (<?= $pemilihan['anggota_1_name'] ?> -
                    <?= $pemilihan['anggota_2_name'] ?>): <?= count($data) ?>
                </h5>
            </div>
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($item['status'] == 1): ?>
                                        ...
                                        <small class="text-muted d-block">OTP Verified</small>
                                    <?php else: ?>
                                        <span class="badge bg-warning">Pending</span>
                                        <small class="text-muted d-block">Menunggu OTP</small>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <form
                                        action="<?= url_to('pemilihan.calon.suara.delete', $pemilihan['id'], $item['id']) ?>"
                                        method="POST">
                                        <?= csrf_field() ?>
                                        <input type="hidden" name="_method" value="DELETE">
                                        <button type="submit" class="btn btn-danger btn-sm"
                                            onclick="return confirm('Apakah Anda yakin ingin menghapus suara ini secara permanen?')">
