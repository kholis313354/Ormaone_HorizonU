            ...
            <div class="card-body">
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title">Kandidat Publish E-Voting</h4>
                        <a href="<?= url_to('pemilihan.calon.create') ?>" class="btn btn-primary">
                            <i class="bi bi-plus-circle"></i> Tambah Kandidat Publish
                        </a>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (!empty($item['gambar_1'])): ?>
                                        <img src="<?= base_url('uploads/' . $item['gambar_1']) ?>" alt="Gambar 1"
                                ...
                                <td>
                                    <?php if (!empty($item['gambar_2'])): ?>
                                        <img src="<?= base_url('uploads/' . $item['gambar_2']) ?>" alt="Gambar 2"
                                            style="width: 50px; height: 50px; object-fit: cover; border-radius: 4px;">
                                    <?php else: ?>
                                        <span class="text-muted">-</span>
                                    <?php endif; ?>
                                ...
                                <td>
                                    <small>
                                        <strong>Mulai:</strong>
                                        <?= date('d/m/Y H:i', strtotime($item['voting_mulai'])) ?><br>
                                        <strong>Selesai:</strong> <?= date('d/m/Y H:i', strtotime($item['voting_akhir'])) ?>
                                    </small>
                                </td>
                                ...
                                <td>
                                    ...
                                    <form action="<?= url_to('pemilihan.calon.delete', $item['id']) ?>" method="POST"
                                        class="d-inline">
                                        <?= csrf_field() ?>
