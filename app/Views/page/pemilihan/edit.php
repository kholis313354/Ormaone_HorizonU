        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= url_to('pemilihan.update', $data['id']) ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="jabatan" name="periode" placeholder="Periode" required value="<?= $data['periode'] ?>">
                        </div>
                        <!-- tanggal_mulai, tanggal_akhir, status -->
                        <div class="mb-3">
                            <label for="tanggal_mulai" class="form-label">Tanggal Mulai</label>
                            <input type="date" class="form-control" id="tanggal_mulai" name="tanggal_mulai" placeholder="Tanggal Mulai" required value="<?= date('Y-m-d', strtotime($data['tanggal_mulai'])) ?>">
                        </div>
                        <div class="mb-3">
                            <label for="tanggal_akhir" class="form-label">Tanggal Akhir</label>
                            <input type="date" class="form-control" id="tanggal_akhir" name="tanggal_akhir" placeholder="Tanggal Akhir" required value="<?= date('Y-m-d', strtotime($data['tanggal_akhir'])) ?>">
                        </div>
                        <div class="mb-3">
