    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?= url_to('pemilihan.update', $data['id']) ?>" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <?php
                        // Extract year from periode if it's in format like "2024/2025" or "2024-2025"
                        $periodeValue = $data['periode'];
                        if (preg_match('/(\d{4})/', $periodeValue, $matches)) {
                            $periodeValue = $matches[1];
                        }
                        ?>
                        <input type="number" class="form-control" id="periode" name="periode"
                            placeholder="Periode (contoh: 2024)" min="2000" max="2100" required
                            value="<?= $periodeValue ?>">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control" id="tanggal_akhir" name="tanggal_akhir"
                            placeholder="Tanggal Akhir" required
                            value="<?= date('Y-m-d\TH:i', strtotime($data['tanggal_akhir'])) ?>">
                    </div>
                    <div class="mb-3">
