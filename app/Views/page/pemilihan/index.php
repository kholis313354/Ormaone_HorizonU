        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="card-title">Waktu E-Voting</h4>
                    <a href="<?= url_to('pemilihan.create') ?>" class="btn btn-primary">
                        <i class="bi bi-plus-circle"></i> Tambah Waktu
                    </a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <?php foreach ($data as $item): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="<?= url_to('pemilihan.delete', $item['id']) ?>" method="POST"
                                        class="d-inline">
                                        <?= csrf_field() ?>
