            ...
            <div class="card-body">
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title">Data Kandidat E-Voting</h4>
                        <a href="<?= url_to('organisasi.anggota.create') ?>" class="btn btn-primary">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($data as $item): ?>
                            <tr>
                                ...
                                <td><?= $item['nim'] ?></td>
                                <td><?= $item['name'] ?></td>
                                <td><?= $item['fakultas_name'] ?? ($item['kelas'] ?? '-') ?></td>
                                <td><?= $item['jurusan'] ?></td>
                                <td><?= $item['phone'] ?></td>
                                <td><?= $item['notes'] ?></td>
                                <td>
                                    ...
                                    <form action="<?= url_to('organisasi.anggota.delete', $item['id']) ?>" method="POST"
                                        class="d-inline">
                                        <?= csrf_field() ?>
