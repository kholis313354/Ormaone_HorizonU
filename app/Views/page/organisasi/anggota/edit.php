    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?= url_to('organisasi.anggota.update', $data['id']) ?>" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <select name="fakultas_id" id="fakultas_id" class="form-select" required>
                            ...
                            <?php foreach ($fakultas as $fak): ?>
                                <option value="<?= $fak['id'] ?>" <?= (old('fakultas_id', $data['fakultas_id']) == $fak['id']) ? 'selected' : '' ?>><?= esc($fak['nama_fakultas']) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="jurusan" name="jurusan" placeholder="Jurusan"
                            required value="<?= old('jurusan', $data['jurusan']) ?>">
                    </div>
                    <div class="mb-3">
