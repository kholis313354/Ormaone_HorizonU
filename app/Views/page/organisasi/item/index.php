            ...
            <div class="card-body">
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?= url_to('organisasi.item.create') ?>" class="btn btn-primary">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($data as $item): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= url_to('organisasi.item.edit', $item['id']) ?>" class="btn btn-primary">
                                        <i class="bi bi-pencil-square btn-sm"></i>
                                        Edit
                                    </a>
                                    <form action="<?= url_to('organisasi.item.delete', $item['id']) ?>" method="POST"
                                        class="d-inline">
                                        <?= csrf_field() ?>
