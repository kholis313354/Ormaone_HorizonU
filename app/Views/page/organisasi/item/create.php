...
<style>
    ...
    .modern-search {
        ...
        width: 320px; /* Diperpanjang sedikit ke kanan */
    }
    ...
    .icon-btn i {
        font-size: 1.125rem; /* Ukuran sedang */
    }
    ...
    .notification-badge {
        ...
        top: -0.125rem;
        right: -0.125rem;
        width: 0.75rem; /* Ukuran sedang */
        height: 0.75rem; /* Ukuran sedang */
        background: #f97316;
    ...
    .user-name {
        font-size: 0.875rem; /* Ukuran sedang */
        font-weight: 500;
        color: #111827;
    }
    ...
    .user-chevron {
        color: #9ca3af;
        font-size: 0.75rem; /* Ukuran sedang */
    }
    ...
    @media (max-width: 991.98px) {
        .modern-search {
            width: 280px; /* Diperpanjang sedikit */
        }
    ...
    @media (max-width: 767.98px) {
        header .d-flex {
            ...
            flex-wrap: nowrap; /* Tidak wrap agar sejajar dalam satu baris */
            align-items: center;
        }
    ...
    <div class="d-flex align-items-center justify-content-between gap-3">
        ...
        <div class="header-right">
            ...
            <div class="dropdown icon-btn-wrapper">
                ...
                <ul class="dropdown-menu dropdown-menu-end bg-brown" aria-labelledby="navbarDropdownNotification">
                    <li>
                        <a class="dropdown-item text-light" href="#!">Notifikasi 1</a>
                        <hr class="dropdown-divider light" />
                    </li>
                    <li>
                        <a class="dropdown-item text-light" href="#!">Notifikasi 2</a>
                    </li>
                </ul>
            </div>
                ...
                <div class="card-body">
                    ...
                    <form action="<?= url_to('organisasi.item.store') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-2">
                                <img id="logoPreview" src="" alt="Preview" style="display: none; width: 150px; height: 150px; object-fit: cover; border-radius: 8px; border: 1px solid #dee2e6;">
                            </div>
                            <small class="form-text text-muted">Pilih file gambar untuk logo organisasi</small>
                        </div>
