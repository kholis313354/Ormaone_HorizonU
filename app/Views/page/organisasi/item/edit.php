                ...
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a
                                href="<?= url_to('organisasi.item.index') ?>">Organisasi</a></li>
            ...
            <div class="card-body">
                ...
                <form action="<?= url_to('organisasi.item.store') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Nama Organisasi"
                            required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-2">
                            <img id="logoPreview" src="" alt="Preview"
                                style="display: none; width: 150px; height: 150px; object-fit: cover; border-radius: 8px; border: 1px solid #dee2e6;">
                        </div>
