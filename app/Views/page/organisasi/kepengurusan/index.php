            ...
            <div class="card-body">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title">Data kepengurusan Pertahun</h4>
                        <a href="<?= url_to('organisasi.kepengurusan.create') ?>" class="btn btn-primary">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (!empty($item['gambar_1'])): ?>
                                        <img src="<?= base_url('uploads/' . $item['gambar_1']) ?>" alt="Gambar Calon"
                                ...
                                <td><a href="<?= url_to('organisasi.kepengurusan.detailSuara', $item['id']) ?>"
                                        class="btn btn-success">
                                        <i class="bi bi-activity"></i>
                                        Detail
                                    </a></td>
                                <td>
                                    <a href="<?= url_to('organisasi.kepengurusan.edit', $item['id']) ?>"
                                        class="btn btn-primary">
                                        <i class="bi bi-pencil-square"></i>
                                        Edit
                                    </a>
                                    <form action="<?= url_to('organisasi.kepengurusan.delete', $item['id']) ?>"
