        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="<?= url_to('organisasi.kepengurusan.create') ?>" class="btn btn-success mb-3">
                        ...
                        <tbody>
                            <?php foreach ($data as $item) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= url_to('organisasi.kepengurusan.edit', $item['id']) ?>" class="btn btn-primary">
                                            <i class="bi bi-pencil-square"></i>
                                            Edit
                                        </a>
                                        <form action="<?= url_to('organisasi.kepengurusan.delete', $item['id']) ?>" method="POST" class="d-inline">
                                            <?= csrf_field() ?>
