    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?= url_to('profile.update') ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>

                    <div class="profile-photo-preview">
                        <div class="profile-photo-circle">
                            <?php if (!empty($user['profile_photo']) && file_exists(FCPATH . 'uploads/profile/' . $user['profile_photo'])): ?>
                                <img src="<?= base_url('uploads/profile/' . $user['profile_photo']) ?>" alt="Profile Photo"
                                    id="profilePreview">
                            <?php else: ?>
                        ...
                        <div class="profile-photo-actions">
                            <label for="profile_photo" class="btn-pilih-foto">
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <a href="<?= url_to('dashboard') ?>" class="btn btn-secondary me-2">Kembali</a>
                        <button type="submit" class="btn-simpan-profile">
            ...
            if (file) {
                ...
                reader.onload = function (e) {
                    if (preview) {
                        ...
                        // Jika belum ada preview, buat elemen img baru
