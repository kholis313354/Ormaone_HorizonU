...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                <form action="<?= url_to('struktur.anggaran.update', $data['id']) ?>" method="POST">
                    <?= csrf_field() ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    value="<?= esc($currentOrganisasi['name'] ?? '-') ?>" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="jumlah">Total Anggaran (Rp)</label>
                                <input type="text" name="jumlah" id="jumlah" class="form-control"
                                    value="<?= number_format($data['jumlah'], 0, ',', '.') ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="mt-4">
                        <button type="submit" class="btn btn-primary">Update</button>
                        <a href="<?= url_to('struktur.index') ?>" class="btn btn-light-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
