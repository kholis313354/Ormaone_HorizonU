    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?= url_to('struktur.proker.update', $data['id']) ?>" method="POST" id="prokerForm">
                    ...
                    <div id="prokerList">
                        <?php
                        $prokerData = json_decode($data['deskripsi'], true);
                        if (!empty($prokerData) && is_array($prokerData)):
                            foreach ($prokerData as $item):
                                ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input type="text" name="proker[]" class="form-control"
                                                value="<?= esc($item['program'] ?? '') ?>" required>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <select name="status_proker[]" class="form-select">
                                                ...
                                                <option value="Finish" <?= ($item['status'] ?? '') == 'Finish' ? 'selected' : '' ?>>Finish</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <label class="form-label small">Total Dana (Rp)</label>
                                            <input type="text" name="dana_berkurang[]" class="form-control rupiah"
                                                value="<?= number_format($item['dana_berkurang'] ?? 0, 0, ',', '.') ?>">
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <label class="form-label small">Link Berita</label>
                                            <input type="url" name="link_berita[]" class="form-control"
                                                value="<?= esc($item['link_berita'] ?? '') ?>">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label small">Keterangan (Opsional)</label>
                                            <textarea name="keterangan[]" class="form-control"
                                                rows="2"><?= esc($item['keterangan'] ?? '') ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <?php
