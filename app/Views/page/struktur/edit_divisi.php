    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?= url_to('struktur.divisi.update', $data['id']) ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="organisasi_id" value="<?= $data['organisasi_id'] ?>">
                    </div>
                    ...
                    <div class="row mb-3">
                         <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_divisi" name="nama_divisi" 
                                   ...
                                   value="<?= esc($data['nama_divisi']) ?>" required maxlength="100">
                        </div>
                        <div class="col-md-6">
                            <label for="tahun" class="form-label">Tahun</label>
                            <input type="text" class="form-control" id="tahun" name="tahun" 
                                   placeholder="Contoh: 2024/2025" 
                                   value="<?= esc($data['tahun']) ?>" required maxlength="50">
                        </div>
                        <div class="col-md-6">
                            <label for="periode" class="form-label">Periode</label>
                            <input type="text" class="form-control" id="periode" name="periode" 
                                   placeholder="Contoh: HUSC 2024-2025" 
                                   value="<?= esc($data['periode']) ?>" maxlength="100">
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <?php if (!empty($data['gambar_ketua'])): ?>
                                        <div class="mb-2">
                                            <img src="<?= base_url('uploads/struktur/divisi/' . $data['gambar_ketua']) ?>" class="preview-image" alt="Current Image">
                                        </div>
                                    <?php endif; ?>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_ketua" name="nama_ketua" 
                                           placeholder="Nama Ketua" value="<?= esc($data['nama_ketua']) ?>" maxlength="100">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="jabatan_ketua" name="jabatan_ketua" 
                                           placeholder="Jabatan" value="<?= esc($data['jabatan_ketua']) ?>" maxlength="100">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="prodi_ketua" name="prodi_ketua" 
                                           placeholder="Program Studi" value="<?= esc($data['prodi_ketua'] ?? '') ?>" maxlength="100">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <?php if (!empty($data['gambar_anggota_' . $i])): ?>
                                        <div class="mb-2">
                                            <img src="<?= base_url('uploads/struktur/divisi/' . $data['gambar_anggota_' . $i]) ?>" class="preview-image" alt="Current Image">
                                        </div>
                                    <?php endif; ?>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_anggota_<?= $i ?>" name="nama_anggota_<?= $i ?>" 
                                           placeholder="Nama Anggota" value="<?= esc($data['nama_anggota_' . $i]) ?>" maxlength="100">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="jabatan_anggota_<?= $i ?>" name="jabatan_anggota_<?= $i ?>" 
                                           placeholder="Jabatan" value="<?= esc($data['jabatan_anggota_' . $i]) ?>" maxlength="100">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="prodi_anggota_<?= $i ?>" name="prodi_anggota_<?= $i ?>" 
                                           placeholder="Program Studi" value="<?= esc($data['prodi_anggota_' . $i] ?? '') ?>" maxlength="100">
                                </div>
                            </div>
                        </div>
                    </div>
