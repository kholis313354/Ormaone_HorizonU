                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="tahun" name="tahun"
                                placeholder="Contoh: 2024/2025" value="<?= esc($data['tahun']) ?>" required
                                maxlength="50">
                        </div>
                        <div class="col-md-6">
                            <label for="periode" class="form-label">Periode</label>
                            <input type="text" class="form-control" id="periode" name="periode"
                                placeholder="Contoh: HUSC 2024-2025" value="<?= esc($data['periode']) ?>"
                                maxlength="100">
                        </div>
                    </div>
                    ...
                    <div class="visi-misi-item">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="visi" name="visi" rows="3"
                                required><?= esc($data['visi']) ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="misi" class="form-label">Misi</label>
                            <textarea class="form-control" id="misi" name="misi" rows="5"
                                required><?= esc($data['misi']) ?></textarea>
