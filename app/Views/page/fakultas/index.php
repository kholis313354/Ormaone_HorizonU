            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <a href="<?= url_to('fakultas.create') ?>" class="btn btn-primary">
                            ...
                            <?php if (!empty($data)): ?>
                                <?php foreach ($data as $item): ?>
                                    <tr>
                                        ...
                                        <td><?= !empty($item['created_at']) ? formatDateTimeIndonesia($item['created_at']) : '-' ?>
                                        </td>
                                        <td><?= !empty($item['updated_at']) ? formatDateTimeIndonesia($item['updated_at']) : '-' ?>
                                        </td>
                                        <td>
                                            <a href="<?= url_to('fakultas.edit', $item['id']) ?>"
                                                class="btn btn-sm btn-warning">
                                                <i class="bi bi-pencil-square"></i> Edit
                                            </a>
                                            <form action="<?= url_to('fakultas.delete', $item['id']) ?>" method="POST"
                                                class="d-inline">
                                                <?= csrf_field() ?>
